...
resource "aws_s3_bucket" "codepipeline_bucket" {
  bucket = "cicd-bucket-${random_string.random.result}"
  force_destroy = true
}
...
data "aws_iam_policy_document" "codepipeline_policy" {
  ...
  statement {
    ...
    resources = [
      "arn:aws:logs:${var.aws_region}:${var.account_id}:log-group:/aws/codepipeline/cicd-pipeline",
      "arn:aws:logs:${var.aws_region}:${var.account_id}:log-group:/aws/codepipeline/cicd-pipeline:log-stream:*"
    ]
  }
}
